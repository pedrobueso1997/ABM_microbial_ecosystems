...
def observe():
    ...
    matplotlib.pyplot.imshow(public_good_2,cmap=cmap2,vmin=0,vmax=5,alpha=0.6)
...
def update():
    ...
    #En este codigo vamos a introducir la idea de secrecion por estimulo; solo se secretan bienes comunes cuando la bacteria sensa que esta rodeada de bacterias de la otra especie
...
os.mkdir("/home/pedro/Simulaciones_modelo_nulo_cooperacion_2e")
os.mkdir("/home/pedro/Simulaciones_modelo_nulo_cooperacion_2e/Distribucion_espacial_0")
os.mkdir("/home/pedro/Simulaciones_modelo_nulo_cooperacion_2e/Distribucion_espacial_500")
os.mkdir("/home/pedro/Simulaciones_modelo_nulo_cooperacion_2e/Distribucion_espacial_1000")
os.mkdir("/home/pedro/Simulaciones_modelo_nulo_cooperacion_2e/Distribucion_espacial_1500")
os.mkdir("/home/pedro/Simulaciones_modelo_nulo_cooperacion_2e/Distribucion_espacial_2000")
os.mkdir("/home/pedro/Simulaciones_modelo_nulo_cooperacion_2e/Evolucion_poblaciones")
os.mkdir("/home/pedro/Simulaciones_modelo_nulo_cooperacion_2e/Coordenadas_espaciales_1000")
os.mkdir("/home/pedro/Simulaciones_modelo_nulo_cooperacion_2e/Coordenadas_espaciales_2000")
...
#Hay que tener cuidado con los documentos e imagenes no se suporpongan; por ello les asignamos nombres distintos
    ...
    initialize()
    observe()
    os.chdir("/home/pedro/Simulaciones_modelo_nulo_cooperacion_2e/Distribucion_espacial_0")
    matplotlib.pyplot.savefig("modelo_nulo_cooperacion_2e_0_"+str(simulacion)+".png")
    ...
    for j in range(number_steps):
        ...
        if j==(number_steps*0.25):
            observe()
            os.chdir("/home/pedro/Simulaciones_modelo_nulo_cooperacion_2e/Distribucion_espacial_500")
            matplotlib.pyplot.savefig("modelo_nulo_cooperacion_2e_500_"+str(simulacion)+".png")
            
        if j==(number_steps*0.5):
            
            observe()
            os.chdir("/home/pedro/Simulaciones_modelo_nulo_cooperacion_2e/Distribucion_espacial_1000")
            matplotlib.pyplot.savefig("modelo_nulo_cooperacion_2e_1000_"+str(simulacion)+".png")
            
            os.chdir("/home/pedro/Simulaciones_modelo_nulo_cooperacion_2e/Coordenadas_espaciales_1000")
            document=open("modelo_nulo_cooperacion_2e_coordenadas_espaciales_1000_"+str(simulacion)+".txt","w")
        ...
        if j==(number_steps*0.75):
            observe()
            os.chdir("/home/pedro/Simulaciones_modelo_nulo_cooperacion_2e/Distribucion_espacial_1500")
            matplotlib.pyplot.savefig("modelo_nulo_cooperacion_2e_1500_"+str(simulacion)+".png")
    
    observe()
    os.chdir("/home/pedro/Simulaciones_modelo_nulo_cooperacion_2e/Distribucion_espacial_2000")
    matplotlib.pyplot.savefig("modelo_nulo_cooperacion_2e_2000_"+str(simulacion)+".png")
    
    os.chdir("/home/pedro/Simulaciones_modelo_nulo_cooperacion_2e/Coordenadas_espaciales_2000")
    document=open("modelo_nulo_cooperacion_2e_coordenadas_espaciales_2000_"+str(simulacion)+".txt","w")
    document.write("Especie" + '\t' + "Coordenadas X" + '\t' + "Coordenadas Y" + '\n')
    for ag in agents:
        document.write(str(ag.type) + '\t' + str(ag.x) + '\t' + str(ag.y) + '\n')
    document.close()

    os.chdir("/home/pedro/Simulaciones_modelo_nulo_cooperacion_2e/Evolucion_poblaciones")
    document=open("modelo_nulo_cooperacion_2e_"+str(simulacion)+".txt","w")
