#MODELO COMPETICION INHIBICION (2 ESPECIES)
...
def observe():
    ...
    if len(species_1)>0:
        matplotlib.pyplot.scatter([ag.x for ag in species_1],[ag.y for ag in species_1], marker="o",color="#E57373")
    if len(species_2)>0:
        matplotlib.pyplot.scatter([ag.x for ag in species_2],[ag.y for ag in species_2], marker="o",color="#E53935")
    #Dibujamos en la grafica las sustancias inhibidoras
    color0 = matplotlib.colors.colorConverter.to_rgba('white')
    color1 = matplotlib.colors.colorConverter.to_rgba('#E57373')
    color2 = matplotlib.colors.colorConverter.to_rgba('#E53935')                                                     
    ...
    matplotlib.pyplot.imshow(inhibitory_2,cmap=cmap2,vmin=0,vmax=5,alpha=0.6)
...
def update():
    ...
    #CONSUMO DEL LAS SUSTANCIAS INHIBIDORAS
    #Ponemos valor a la variable consume_inhibidor_2
    #Solo la especie 1 puede consumir el inhibidor 2
    if species==1:
    ...
    #Solo la especie 2 puede consumir el inhibidor 1
    elif species==2:
        consume_inhibidor_2=False
    ...
    #El agente puede haber consumido un inhibidor o no haberlo hecho
...
os.mkdir("/home/pedro/Simulaciones_modelo_nulo_competicion_inhibicion_2e")
os.mkdir("/home/pedro/Simulaciones_modelo_nulo_competicion_inhibicion_2e/Distribucion_espacial_0")
os.mkdir("/home/pedro/Simulaciones_modelo_nulo_competicion_inhibicion_2e/Distribucion_espacial_500")
os.mkdir("/home/pedro/Simulaciones_modelo_nulo_competicion_inhibicion_2e/Distribucion_espacial_1000")
os.mkdir("/home/pedro/Simulaciones_modelo_nulo_competicion_inhibicion_2e/Distribucion_espacial_1500")
os.mkdir("/home/pedro/Simulaciones_modelo_nulo_competicion_inhibicion_2e/Distribucion_espacial_2000")
os.mkdir("/home/pedro/Simulaciones_modelo_nulo_competicion_inhibicion_2e/Evolucion_poblaciones")
os.mkdir("/home/pedro/Simulaciones_modelo_nulo_competicion_inhibicion_2e/Coordenadas_espaciales_1000")
os.mkdir("/home/pedro/Simulaciones_modelo_nulo_competicion_inhibicion_2e/Coordenadas_espaciales_2000")
...
#Hay que tener cuidado con los documentos e imagenes no se suporpongan; por ello les asignamos nombres distintos
    ...
    initialize()
    observe()
    os.chdir("/home/pedro/Simulaciones_modelo_nulo_competicion_inhibicion_2e/Distribucion_espacial_0")
    matplotlib.pyplot.savefig("modelo_nulo_competicion_inhibicion_2e_0_"+str(simulacion)+".png")
    ...
    for j in range(number_steps):
        ...
        if j==(number_steps*0.25):
            observe()
            os.chdir("/home/pedro/Simulaciones_modelo_nulo_competicion_inhibicion_2e/Distribucion_espacial_500")
            matplotlib.pyplot.savefig("modelo_nulo_competicion_inhibicion_2e_500_"+str(simulacion)+".png")
            
        if j==(number_steps*0.5):
            
            observe()
            os.chdir("/home/pedro/Simulaciones_modelo_nulo_competicion_inhibicion_2e/Distribucion_espacial_1000")
            matplotlib.pyplot.savefig("modelo_nulo_competicion_inhibicion_2e_1000_"+str(simulacion)+".png")
            
            os.chdir("/home/pedro/Simulaciones_modelo_nulo_competicion_inhibicion_2e/Coordenadas_espaciales_1000")
            document=open("modelo_nulo_competicion_inhibicion_2e_coordenadas_espaciales_1000_"+str(simulacion)+".txt","w")
        ...
        if j==(number_steps*0.75):
            observe()
            os.chdir("/home/pedro/Simulaciones_modelo_nulo_competicion_inhibicion_2e/Distribucion_espacial_1500")
            matplotlib.pyplot.savefig("modelo_nulo_competicion_inhibicion_2e_1500_"+str(simulacion)+".png")
    
    observe()
    os.chdir("/home/pedro/Simulaciones_modelo_nulo_competicion_inhibicion_2e/Distribucion_espacial_2000")
    matplotlib.pyplot.savefig("modelo_nulo_competicion_inhibicion_2e_2000_"+str(simulacion)+".png")
    
    os.chdir("/home/pedro/Simulaciones_modelo_nulo_competicion_inhibicion_2e/Coordenadas_espaciales_2000")
    document=open("modelo_nulo_competicion_inhibicion_2e_coordenadas_espaciales_2000_"+str(simulacion)+".txt","w")
    document.write("Especie" + '\t' + "Coordenadas X" + '\t' + "Coordenadas Y" + '\n')
    for ag in agents:
        document.write(str(ag.type) + '\t' + str(ag.x) + '\t' + str(ag.y) + '\n')
    document.close()

    os.chdir("/home/pedro/Simulaciones_modelo_nulo_competicion_inhibicion_2e/Evolucion_poblaciones")
    document=open("modelo_nulo_competicion_inhibicion_2e_"+str(simulacion)+".txt","w")
