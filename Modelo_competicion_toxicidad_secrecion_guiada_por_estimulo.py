#MODELO COMPETICION TOXICIDAD + SECRECION GUIADA POR ESTIMULO
...
def update():
    ...
    #CONSUMO DE LAS SUSTANCIAS TOXICAS
...
os.mkdir("/home/pedro/Simulaciones_modelo_competicion_toxicidad_se")
os.mkdir("/home/pedro/Simulaciones_modelo_competicion_toxicidad_se/Distribucion_espacial_inicial")
os.mkdir("/home/pedro/Simulaciones_modelo_competicion_toxicidad_se/Distribucion_espacial_mitad")
os.mkdir("/home/pedro/Simulaciones_modelo_competicion_toxicidad_se/Distribucion_espacial_final")
os.mkdir("/home/pedro/Simulaciones_modelo_competicion_toxicidad_se/Evolucion_poblaciones")
os.mkdir("/home/pedro/Simulaciones_modelo_competicion_toxicidad_se/Coordenadas_espaciales")
...
#Generamos una documento con las coordenadas de cada agente al final de la simulacion
    ...
    initialize()
    observe()
    os.chdir("/home/pedro/Simulaciones_modelo_competicion_toxicidad_se/Distribucion_espacial_inicial")
    ...
    for j in range(number_steps):
        ...
        if j==(number_steps/2):
            observe()
            os.chdir("/home/pedro/Simulaciones_modelo_competicion_toxicidad_se/Distribucion_espacial_mitad")
            matplotlib.pyplot.savefig("modelo_competicion_toxicidad_mitad_"+str(simulacion)+".png")
    
    observe()
    os.chdir("/home/pedro/Simulaciones_modelo_competicion_toxicidad_se/Distribucion_espacial_final")
    matplotlib.pyplot.savefig("modelo_competicion_toxicidad_final_"+str(simulacion)+".png")
    
    os.chdir("/home/pedro/Simulaciones_modelo_competicion_toxicidad_se/Coordenadas_espaciales")
    ...
    os.chdir("/home/pedro/Simulaciones_modelo_competicion_toxicidad_se/Evolucion_poblaciones")
