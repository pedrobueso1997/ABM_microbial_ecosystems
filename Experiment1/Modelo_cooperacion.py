...
def observe():
    ...
    #En la funcion imshow() el primer argumento indica el array con la informacion de concentracion por localizacion, el segundo argumento indica la escala de color, el tercer y cuarto argumento indican los valores maximos y minimos para ajustar la escala de color
...
os.mkdir("/home/pedro/Simulaciones_modelo_cooperacion")
os.mkdir("/home/pedro/Simulaciones_modelo_cooperacion/Distribucion_espacial_inicial")
os.mkdir("/home/pedro/Simulaciones_modelo_cooperacion/Distribucion_espacial_mitad")
os.mkdir("/home/pedro/Simulaciones_modelo_cooperacion/Distribucion_espacial_final")
os.mkdir("/home/pedro/Simulaciones_modelo_cooperacion/Evolucion_poblaciones")
os.mkdir("/home/pedro/Simulaciones_modelo_cooperacion/Coordenadas_espaciales")
...
#Generamos una imagen con las poblaciones de cada especie y total a cada momento de la simulacion
#Hay que tener cuidado con los documentos e imagenes no se suporpongan; por ello les asignamos nombres distintos

    initialize()
    observe()
    os.chdir("/home/pedro/Simulaciones_modelo_cooperacion/Distribucion_espacial_inicial")
    ...
    for j in range(number_steps):
        ...
        if j==(number_steps/2):
            observe()
            os.chdir("/home/pedro/Simulaciones_modelo_cooperacion/Distribucion_espacial_mitad")
            matplotlib.pyplot.savefig("modelo_cooperacion_mitad_"+str(simulacion)+".png")
    
    observe()
    os.chdir("/home/pedro/Simulaciones_modelo_cooperacion/Distribucion_espacial_final")
    matplotlib.pyplot.savefig("modelo_cooperacion_final_"+str(simulacion)+".png")
    
    os.chdir("/home/pedro/Simulaciones_modelo_cooperacion/Coordenadas_espaciales")
    ...
    os.chdir("/home/pedro/Simulaciones_modelo_cooperacion/Evolucion_poblaciones")
    document=open("modelo_cooperacion_"+str(simulacion)+".txt","w")
