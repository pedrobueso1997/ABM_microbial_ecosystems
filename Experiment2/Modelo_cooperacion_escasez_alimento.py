#MODELO COOPERACION + ESCASEZ DE ALIMENTO
...
def update():
    ...
    #CONSUMO DE LOS BIENES COMUNES Y DE ALIMENTO
...
os.mkdir("/home/pedro/Simulaciones_modelo_cooperacion_ea")
os.mkdir("/home/pedro/Simulaciones_modelo_cooperacion_ea/Distribucion_espacial_inicial")
os.mkdir("/home/pedro/Simulaciones_modelo_cooperacion_ea/Distribucion_espacial_mitad")
os.mkdir("/home/pedro/Simulaciones_modelo_cooperacion_ea/Distribucion_espacial_final")
os.mkdir("/home/pedro/Simulaciones_modelo_cooperacion_ea/Evolucion_poblaciones")
os.mkdir("/home/pedro/Simulaciones_modelo_cooperacion_ea/Coordenadas_espaciales")
...
#Hay que tener cuidado con los documentos e imagenes no se suporpongan; por ello les asignamos nombres distintos
    ...
    initialize()
    observe()
    os.chdir("/home/pedro/Simulaciones_modelo_cooperacion_ea/Distribucion_espacial_inicial")
    ...
    for j in range(number_steps):
        ...
        if j==(number_steps/2):
            observe()
            os.chdir("/home/pedro/Simulaciones_modelo_cooperacion_ea/Distribucion_espacial_mitad")
            matplotlib.pyplot.savefig("modelo_cooperacion_mitad_"+str(simulacion)+".png")
    
    observe()
    os.chdir("/home/pedro/Simulaciones_modelo_cooperacion_ea/Distribucion_espacial_final")
    matplotlib.pyplot.savefig("modelo_cooperacion_final_"+str(simulacion)+".png")
    
    os.chdir("/home/pedro/Simulaciones_modelo_cooperacion_ea/Coordenadas_espaciales")
    ...
    os.chdir("/home/pedro/Simulaciones_modelo_cooperacion_ea/Evolucion_poblaciones")
