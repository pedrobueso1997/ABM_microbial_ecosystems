#MODELO COMPETICION INHIBICION + SECRECION GUIADA POR ESTIMULO
...
#Tasa de secrecion de la sustancia inhibidoras
...
os.mkdir("/home/pedro/Simulaciones_modelo_competicion_inhibicion_se")
os.mkdir("/home/pedro/Simulaciones_modelo_competicion_inhibicion_se/Distribucion_espacial_inicial")
os.mkdir("/home/pedro/Simulaciones_modelo_competicion_inhibicion_se/Distribucion_espacial_mitad")
os.mkdir("/home/pedro/Simulaciones_modelo_competicion_inhibicion_se/Distribucion_espacial_final")
os.mkdir("/home/pedro/Simulaciones_modelo_competicion_inhibicion_se/Evolucion_poblaciones")
os.mkdir("/home/pedro/Simulaciones_modelo_competicion_inhibicion_se/Coordenadas_espaciales")
...
#Hay que tener cuidado con los documentos e imagenes no se suporpongan; por ello les asignamos nombres distintos
    ...
    initialize()
    observe()
    os.chdir("/home/pedro/Simulaciones_modelo_competicion_inhibicion_se/Distribucion_espacial_inicial")
    ...
    for j in range(number_steps):
        ...
        if j==(number_steps/2):
            observe()
            os.chdir("/home/pedro/Simulaciones_modelo_competicion_inhibicion_se/Distribucion_espacial_mitad")
            matplotlib.pyplot.savefig("modelo_competicion_inhibicion_mitad_"+str(simulacion)+".png")
    
    observe()
    os.chdir("/home/pedro/Simulaciones_modelo_competicion_inhibicion_se/Distribucion_espacial_final")
    matplotlib.pyplot.savefig("modelo_competicion_inhibicion_final_"+str(simulacion)+".png")
    
    os.chdir("/home/pedro/Simulaciones_modelo_competicion_inhibicion_se/Coordenadas_espaciales")
    ...
    os.chdir("/home/pedro/Simulaciones_modelo_competicion_inhibicion_se/Evolucion_poblaciones")
