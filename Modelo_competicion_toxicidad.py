...
os.mkdir("/home/pedro/Simulaciones_modelo_competicion_toxicidad")
os.mkdir("/home/pedro/Simulaciones_modelo_competicion_toxicidad/Distribucion_espacial_inicial")
os.mkdir("/home/pedro/Simulaciones_modelo_competicion_toxicidad/Distribucion_espacial_mitad")
os.mkdir("/home/pedro/Simulaciones_modelo_competicion_toxicidad/Distribucion_espacial_final")
os.mkdir("/home/pedro/Simulaciones_modelo_competicion_toxicidad/Evolucion_poblaciones")
os.mkdir("/home/pedro/Simulaciones_modelo_competicion_toxicidad/Coordenadas_espaciales")
...
#Generamos una documento con las coordenadas de cada agente al final de la simulacion
    ...
    initialize()
    observe()
    os.chdir("/home/pedro/Simulaciones_modelo_competicion_toxicidad/Distribucion_espacial_inicial")
    ...
    for j in range(number_steps):
        ...
        if j==(number_steps/2):
            observe()
            os.chdir("/home/pedro/Simulaciones_modelo_competicion_toxicidad/Distribucion_espacial_mitad")
            matplotlib.pyplot.savefig("modelo_competicion_toxicidad_mitad_"+str(simulacion)+".png")
    
    observe()
    os.chdir("/home/pedro/Simulaciones_modelo_competicion_toxicidad/Distribucion_espacial_final")
    matplotlib.pyplot.savefig("modelo_competicion_toxicidad_final_"+str(simulacion)+".png")
    
    os.chdir("/home/pedro/Simulaciones_modelo_competicion_toxicidad/Coordenadas_espaciales")
    ...
    os.chdir("/home/pedro/Simulaciones_modelo_competicion_toxicidad/Evolucion_poblaciones")
    document=open("modelo_competicion_toxicidad_"+str(simulacion)+".txt","w")
