#MODELO COOPERACION (2 ESPECIES) + COMPETICION TOXICIDAD (2 ESPECIES)
...
def observe():
    ...
    if len(species_3)>0:
        matplotlib.pyplot.scatter([ag.x for ag in species_3],[ag.y for ag in species_3], marker="o",color="#FF7043")
    if len(species_4)>0:
    ...
    color3 = matplotlib.colors.colorConverter.to_rgba('#FF7043')
...
def update():
    ...
    #La especie 1 puede consumir el bien comun 2, la toxina 3 y la toxina 4
    #La especie 2 puede consumir el bien comun 1, la toxina 3 y la toxina 4
    #La especie 3 puede consumir la toxina 4
    #La especie 4 puede consumir la toxina 3
    ...
    #El agente puede haber consumido un bien comun, haber consumido una toxina o no haber consumido nada
...
os.mkdir("/home/pedro/Simulaciones_modelo_mixto_cooperacion_competicion_toxicidad")
os.mkdir("/home/pedro/Simulaciones_modelo_mixto_cooperacion_competicion_toxicidad/Distribucion_espacial_0")
os.mkdir("/home/pedro/Simulaciones_modelo_mixto_cooperacion_competicion_toxicidad/Distribucion_espacial_500")
os.mkdir("/home/pedro/Simulaciones_modelo_mixto_cooperacion_competicion_toxicidad/Distribucion_espacial_1000")
os.mkdir("/home/pedro/Simulaciones_modelo_mixto_cooperacion_competicion_toxicidad/Distribucion_espacial_1500")
os.mkdir("/home/pedro/Simulaciones_modelo_mixto_cooperacion_competicion_toxicidad/Distribucion_espacial_2000")
os.mkdir("/home/pedro/Simulaciones_modelo_mixto_cooperacion_competicion_toxicidad/Evolucion_poblaciones")
os.mkdir("/home/pedro/Simulaciones_modelo_mixto_cooperacion_competicion_toxicidad/Coordenadas_espaciales_1000")
os.mkdir("/home/pedro/Simulaciones_modelo_mixto_cooperacion_competicion_toxicidad/Coordenadas_espaciales_2000")
...
#Hay que tener cuidado con los documentos e imagenes no se suporpongan; por ello les asignamos nombres distintos
    ...
    initialize()
    observe()
    os.chdir("/home/pedro/Simulaciones_modelo_mixto_cooperacion_competicion_toxicidad/Distribucion_espacial_0")
    matplotlib.pyplot.savefig("modelo_mixto_cooperacion_competicion_toxicidad_0_"+str(simulacion)+".png")
    ...
    for j in range(number_steps):
        ...
        if j==(number_steps*0.25):
            observe()
            os.chdir("/home/pedro/Simulaciones_modelo_mixto_cooperacion_competicion_toxicidad/Distribucion_espacial_500")
            matplotlib.pyplot.savefig("modelo_mixto_cooperacion_competicion_toxicidad_500_"+str(simulacion)+".png")
            
        if j==(number_steps*0.5):
            
            observe()
            os.chdir("/home/pedro/Simulaciones_modelo_mixto_cooperacion_competicion_toxicidad/Distribucion_espacial_1000")
            matplotlib.pyplot.savefig("modelo_mixto_cooperacion_competicion_toxicidad_1000_"+str(simulacion)+".png")
            
            os.chdir("/home/pedro/Simulaciones_modelo_mixto_cooperacion_competicion_toxicidad/Coordenadas_espaciales_1000")
            document=open("modelo_mixto_cooperacion_competicion_toxicidad_coordenadas_espaciales_1000_"+str(simulacion)+".txt","w")
        ...
        if j==(number_steps*0.75):
            observe()
            os.chdir("/home/pedro/Simulaciones_modelo_mixto_cooperacion_competicion_toxicidad/Distribucion_espacial_1500")
            matplotlib.pyplot.savefig("modelo_mixto_cooperacion_competicion_toxicidad_1500_"+str(simulacion)+".png")
    
    observe()
    os.chdir("/home/pedro/Simulaciones_modelo_mixto_cooperacion_competicion_toxicidad/Distribucion_espacial_2000")
    matplotlib.pyplot.savefig("modelo_mixto_cooperacion_competicion_toxicidad_2000_"+str(simulacion)+".png")
    
    os.chdir("/home/pedro/Simulaciones_modelo_mixto_cooperacion_competicion_toxicidad/Coordenadas_espaciales_2000")
    document=open("modelo_mixto_cooperacion_competicion_toxicidad_coordenadas_espaciales_2000_"+str(simulacion)+".txt","w")
    document.write("Especie" + '\t' + "Coordenadas X" + '\t' + "Coordenadas Y" + '\n')
    for ag in agents:
        document.write(str(ag.type) + '\t' + str(ag.x) + '\t' + str(ag.y) + '\n')
    document.close()

    os.chdir("/home/pedro/Simulaciones_modelo_mixto_cooperacion_competicion_toxicidad/Evolucion_poblaciones")
    document=open("modelo_mixto_cooperacion_competicion_toxicidad_"+str(simulacion)+".txt","w")
