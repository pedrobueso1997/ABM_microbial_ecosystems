#MODELO COMPETICION INHIBICION + ESCASEZ DE ALIMENTO
...
def observe():
    ...
    #Dibujamos en la grafica los alimentos y las sustancias inhibidoras
...
def update():
    ...
    #CONSUMO DE LAS SUSTANCIAS INHIBIDORAS Y DE ALIMENTO
    ...
    if consume_inhibidor_2==True or consume_inhibidor_1==True:
        if random()<(reproduction_rate-((reproduction_rate)*(n/max_number)))/2*(1-sum(1 for x in agents)//carrying_capacity):
            newborn=copy(ag) 
...
os.mkdir("/home/pedro/Simulaciones_modelo_competicion_inhibicion_ea")
os.mkdir("/home/pedro/Simulaciones_modelo_competicion_inhibicion_ea/Distribucion_espacial_inicial")
os.mkdir("/home/pedro/Simulaciones_modelo_competicion_inhibicion_ea/Distribucion_espacial_mitad")
os.mkdir("/home/pedro/Simulaciones_modelo_competicion_inhibicion_ea/Distribucion_espacial_final")
os.mkdir("/home/pedro/Simulaciones_modelo_competicion_inhibicion_ea/Evolucion_poblaciones")
os.mkdir("/home/pedro/Simulaciones_modelo_competicion_inhibicion_ea/Coordenadas_espaciales")
...
#Hay que tener cuidado con los documentos e imagenes no se suporpongan; por ello les asignamos nombres distintos
    ...
    initialize()
    observe()
    os.chdir("/home/pedro/Simulaciones_modelo_competicion_inhibicion_ea/Distribucion_espacial_inicial")
    ...
    for j in range(number_steps):
        ...
        if j==(number_steps/2):
            observe()
            os.chdir("/home/pedro/Simulaciones_modelo_competicion_inhibicion_ea/Distribucion_espacial_mitad")
            matplotlib.pyplot.savefig("modelo_competicion_inhibicion_mitad_"+str(simulacion)+".png")
    
    observe()
    os.chdir("/home/pedro/Simulaciones_modelo_competicion_inhibicion_ea/Distribucion_espacial_final")
    matplotlib.pyplot.savefig("modelo_competicion_inhibicion_final_"+str(simulacion)+".png")
    
    os.chdir("/home/pedro/Simulaciones_modelo_competicion_inhibicion_ea/Coordenadas_espaciales")
    ...
    os.chdir("/home/pedro/Simulaciones_modelo_competicion_inhibicion_ea/Evolucion_poblaciones")
    document=open("modelo_competicion_inhibicion_evolucion_poblaciones"+str(simulacion)+".txt","w")
